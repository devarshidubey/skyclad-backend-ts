...
import { createDocumentController, getDocumentController, updateDocumentController, deleteDocumentController } from "../controllers/document/document.controller.js";
...
router.delete('/:documentId', authorize, authorizePermission("documents:delete"), deleteDocumentController)
